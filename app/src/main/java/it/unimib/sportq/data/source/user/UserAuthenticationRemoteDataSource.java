...
import static it.unimib.sportq.util.Constants.UNEXPECTED_ERROR;
import static it.unimib.sportq.util.Constants.USER_COLLISION_ERROR;
import static it.unimib.sportq.util.Constants.WEAK_PASSWORD_ERROR;
